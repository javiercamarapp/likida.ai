...
--
-- Los 41 primeros son la lista de la 0231 copiada TAL CUAL: global + 8 de
-- flota/redactor + 4 financieros + 4 de dirección + 3 de prospección + 6 de
-- éxito + 4 de back office + 10 de crecimiento + la descarga del SAT. Los 9 de
-- abajo son los de esta migración. Total: 50.
...
comment on constraint interruptor_id_dominio on public.interruptor is
  'El dominio COMPLETO de palancas (50 al 0235 — el catálogo entero de la compañía agente, 60/60 vivos, más la global). Cada migración que enciende agentes lo RECREA enumerando todo el catálogo: la recreación más alta gana, y una que enumere solo los suyos borraría en silencio las palancas anteriores (el incidente que la 0227 corrigió). El espejo en código es INTERRUPTORES en src/lib/likida/interruptores.ts.';

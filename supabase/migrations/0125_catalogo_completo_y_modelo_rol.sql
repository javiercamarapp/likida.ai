...
insert into public.agente_definicion (id, nombre, departamento, disparador, estado, modelo_rol, prompt_ref, descripcion) values
  ...
  ('auditor_codigo',     'Auditor de código',            'ingenieria', 'cron',   'disenado', 'codigo', '10-Ingenieria-y-Producto/agente-auditor-de-codigo.md', 'AUDITA (hallazgos, no diffs) — regla final del 16-ago: ver el código sí; cambiarlo no. Caza en manada con los testers (qa); el FIX corre con codigo_escritura (Sonnet, USA). La skill auditoria-diaria ya existe.'),

...
insert into public.agente_definicion (id, nombre, departamento, disparador, estado, modelo_rol, prompt_ref, descripcion) values
  ...
  ('visuales',           'Visuales de marca',            'crecimiento', 'manual', 'disenado', null, '06-Imagen-y-Video/agente-visuales.md', 'Piezas gráficas de marca. Motor: subagente likida-marketing + Higgsfield (fuera del stack de texto).'),
  ('video_demo',         'Video de demo',                'crecimiento', 'manual', 'disenado', null, '06-Imagen-y-Video/agente-video-demo.md', 'El video que se manda antes de la llamada.'),
  ('video_marketing',    'Video de marketing',           'crecimiento', 'manual', 'disenado', null, '06-Imagen-y-Video/agente-video-marketing.md', 'Reels y shorts para el gremio.'),

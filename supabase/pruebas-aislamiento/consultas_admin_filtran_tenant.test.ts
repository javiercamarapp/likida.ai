...
const ALLOWLIST: Record<string, string> = {
  ...
  'src/lib/admin/slo.ts': 'SLOs medidos del PRODUCTO (fase 7): agrega agente_corrida y liquidacion de TODA la operación para decir si Likida cumple su objetivo. Un filtro por tenant mediría el SLO de una flota. Solo /admin, requireSuperadmin.',

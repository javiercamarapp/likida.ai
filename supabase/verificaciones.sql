...
-- ── 196. El registro de jornada: la procedencia obligatoria, la corrección que se anota, y el chofer que no se puede borrar (mig. 0241) ──
-- El bloque 173 que la consigna reservaba YA ESTABA TOMADO (la dirección, mig.
-- 0216, línea 9712), y el 195 es el último escrito. Éste toma el 196.
--

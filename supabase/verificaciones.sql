...
-- ── 196. La verdad-de-terreno del banco de QA y sus lecturas (mig. 0239) ────
-- ═══════════════════════════════════════════════════════════════════════════
-- CORRECTIVA 0239 — LA VERDAD-DE-TERRENO ES UN CONTRATO DE LA BASE, Y CADA
-- LECTURA DEL OCR QUEDA ESCRITA CON SU MEDICIÓN
--
-- El ordinal es 196 y no 194: el 194 y el 195 ya están tomados en master, y
-- las dos ramas que corren en paralelo a esta reservaron los suyos. El número

...
-- ── 190. Los nueve que cierran la compañía agente: 60/60 vivos, 50 palancas y una pieza por clave (mig. 0235) ──
-- Los bloques 188 y 189 los toman las olas de ingeniería (0233) y de re-login
-- (0234), paralelas a ésta; aquí se toma el 190 y el hueco lo cierran ellas al
-- mergear.
--
...
--  (d) LAS 50 PALANCAS. Las 9 nuevas entran, y —la trampa que la 0227 corrigió
--      y que se repite en cada ola— las 41 ANTERIORES siguen en el dominio: si
--      esta migración hubiera enumerado solo las suyas, apagar a `talento`, a
--      `redactor` o a `descarga_sat` rebotaría con check_violation el día del
--      incidente, que es el peor día para descubrirlo.

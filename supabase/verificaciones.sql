...
-- ── 205. producto_evento se consolida al cerrar el mes, purga su detalle y el lector no ve encoger nada (mig. 0259) ──
--
-- (En la rama del 0258 este número lo toman sus bloques; la numeración es de
-- lectura, no de ejecución — quien fusione después renumera, como ya pasó
-- dos veces con el 201.)
--

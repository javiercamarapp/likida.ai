...
- Compuerta al cerrar: `npm test` **9,995 pruebas en 708 archivos**, todas verdes · `npx tsc --noEmit` 0 errores · `npm run lint` 0 errores. `npm run build` no corre aquí a propósito.

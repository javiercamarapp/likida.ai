 ...
 *  su departamento, luego el piso universal del plan (texto libre). LANZA
 *  si el agente no existe en `agente_definicion`: el llamador (la página de
 *  insumos) ya resolvió esa fila antes de preguntar esto. */
